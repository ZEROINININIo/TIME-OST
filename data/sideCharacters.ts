...
export const sideCharacters: SideCharacterData[] = [
  {
    ...
    translations: {
      'zh-CN': {
        ...
        enName: "Z.Byaki",
        role: "起源",
        tags: ["泽洛希家族", "逝者", "小空", "眼镜娘"],
        quote: "今天，也能活下去。",
        description: [
          "**身份:** Void 尚未成为高维存在时的名字。她是故事的起始点之一。",
          "**特征:** 佩戴一副细框眼镜，显得文静知性（与芷漓不同，芷漓不戴眼镜）。",
      ...
      'zh-TW': {
        ...
        description: [
          ...
          "**特徵:** 佩戴一副細框眼鏡，顯得文靜知性（與芷漓不同，芷漓不戴眼鏡）。",
      ...
      'en': {
        ...
        enName: "Z.Byaki",
        role: "Origin",
        tags: ["Zeloshi", "Deceased", "Void", "Glasses"],
        ...
        description: [
          ...
          "**Appearance:** Wears thin-framed glasses, giving her a quiet and intellectual look (unlike Zeri, who does not wear glasses).",
